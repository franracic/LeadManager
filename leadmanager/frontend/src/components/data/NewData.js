...
export default function NewData() {
  ...
  return (
    <main className="relative h-screen bg-gray-100 dark:bg-gray-800 z-30 w-full">
      <div className="flex-column">
        <div className="flex items-start justify-between">
          <div className="flex flex-col w-full md:space-y-4">
            <div className="h-auto px-4 pb-24 overflow-auto md:px-6">
              <h1 className="text-4xl font-semibold text-gray-800 dark:text-white">
                Good afternoon, {auth.user.username}
              </h1>
              ...
              <div className="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                ...
                >
                  ...
                  <p className="mb-4 text-gray-500 dark:text-gray-400">
                    Get started with a free and open-source admin dashboard
                    layout built with Tailwind CSS and Flowbite featuring
                    charts, widgets, CRUD layouts, authentication pages, and
                    more
                  </p>
                  ...
                  <ul className="pl-4 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                    <li>
                      What are the new challenges in the delivery industry due
                      to new consumer expectations.
                    </li>
                    <li>
                      How the online delivery business model is diversifying to
                      meet new demands.
                    </li>
                    <li>
                      Which new technology requirements must be met to ensure
                      true retail experiences.
                    </li>
                    <li>
                      How a headless commerce architecture solves challenges in
                      the industry.
                    </li>
                  </ul>
                  <a
                ...
                >
                  ...
                  <p className="mb-4 text-gray-500 dark:text-gray-400">
                    Marketing, sales & business growth for small business.
                    Improve your marketing & promotion results - and grow your
                    sales!
                  </p>
                  ...
                  >
                    ...
                    <li className="flex space-x-2">
                      ...
                      <span className="leading-tight">
                        Build relationships with other businesses to co-promote
                      </span>
                    </li>
                    <li className="flex space-x-2">
                      <svg
                      ...
                      <span className="leading-tight">
                        Make their customers feel loved and apprecaited
                      </span>
                    </li>
                  </ul>
                  <a
