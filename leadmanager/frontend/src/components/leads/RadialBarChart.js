      ...
      <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
        <div className="grid grid-cols-4 gap-3 mb-2">
          ...
          <dl className="bg-gray-200 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
            <dt className="w-8 h-8 rounded-full bg-gray-300 dark:bg-gray-500 text-gray-600 dark:text-orange-300 text-sm font-medium flex items-center justify-center mb-1">
              {notStarted}
            </dt>
            <dd className="text-gray-600 dark:text-orange-300 text-sm font-medium">
              Not started
            </dd>
          </dl>
        </div>
