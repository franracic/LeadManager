...
const About = () => {
  return (
    <>
      <section className="overflow-hidden pt-20 pb-12 lg:pb-[90px] snap-center">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12 ">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="mb-5 text-base text-white dark:text-dark-6">
                  We are a Wyoming-based agency dedicated to assisting companies
                  in obtaining high-quality, ready-to-engage leads through
                  strategic advertising on popular social media platforms.
                </p>
                <p className="mb-8 text-base text-white dark:text-dark-6">
                  Our focused approach not only allows you to focus on your core
                  work but also guarantees that your business expansion is
                  powered by genuinely interested clients, ensuring a seamless
