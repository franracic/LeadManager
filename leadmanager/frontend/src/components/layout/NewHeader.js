...
function CustomNavLink({ to, children, ...props }) {
  ...
  return (
    <NavLink
      ...
      className={
        isActive
          ? "flex items-center justify-start w-full p-2 pl-6 my-2 text-gray-800 transition-colors duration-200 border-l-4 border-green-500 dark:text-white"
        ...
        <nav className="mt-6">
          <div>
            ...
            <CustomNavLink to="/data">
              ...
              <span className="mx-4 text-sm font-normal">Data</span>
            </CustomNavLink>
